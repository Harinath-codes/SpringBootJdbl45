...
public class BookController {
    ...
    //List of roles our minor proj 1 can have ---- STUDENT, Admin , Librarian
    
    //1) can student create a new book in lib ----> No
    //2) can update the detaails of the book ---> No
    
    
    ///Get ----> Student role can have acess, Admin
    //Post, Put, Delete ---> Admin
